export default {
    "langs": {
        "en-US": {
            ...
            "index#program#modal_settings@settings_checkbox_1": "Enable monetized posts<br>(ad blockers must be disabled)",
            "index#program#modal_settings@settings_checkbox_2": "Stories pause when opening [instantgram-light]",
            "index#program#modal_settings@settings_checkbox_3": "Open download in new tab",
            "index#program#modal_settings@settings_checkbox_4": "Mute stories",
        ...
        "de-DE": {
            ...
            "index#program#modal_settings@settings_general_description_4": "Ändere hier das Dateinamenformat für die Downloads<br/>Das Standardformat ist<br>{Username}__{Year}-{Month}-{Day}--{Hour}-{Minute}",
        ...
        "es-AR": {
            ...
            "index#program#modal_settings@settings_checkbox_1": "Habilitar publicaciones monetizadas<br>(los bloqueadores de anuncios deben estar deshabilitados)",
            "index#program#modal_settings@settings_checkbox_2": "Historias en pausa al abrir [instantgram-light]",
            "index#program#modal_settings@settings_checkbox_3": "Abrir la descarga en una nueva pestaña",
        ...
        "pt-BR": {
            ...
            "index#program#modal_settings@settings_checkbox_1": "Habilitar postagens monetizadas<br>(os bloqueadores de anúncios devem estar desativados)",
            "index#program#modal_settings@settings_checkbox_2": "As histórias fazem uma pausa ao abrir [instantgram-light]",
            "index#program#modal_settings@settings_checkbox_3": "Abrir o download em uma nova guia",
