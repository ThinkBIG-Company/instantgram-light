export default {
    "langs": {
        "en-US": {
            ...
            "index#program#modal_settings@settings_general_description_4": "Change the file name format for the downloads here<br/>The default format is<br>{Username}__{Year}-{Month}-{Day}--{Hour}-{Minute}",
        ...
        "es-AR": {
            ...
            "index#program#modal_settings@settings_general_description_4": "Cambie el formato del nombre de archivo para las descargas aquí<br/>El formato predeterminado es<br>{Username}__{Year}-{Month}-{Day}--{Hour}-{Minute}",
        ...
        "pt-BR": {
            ...
            "index#program#modal_settings@settings_general_description_4": "Altere o formato do nome do arquivo para os downloads aqui<br/>O formato padrão é<br>{Username}__{Year}-{Month}-{Day}--{Hour}-{Minute}",
